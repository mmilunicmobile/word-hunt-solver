...
englishWords = (
    set()
)  # LARGE set that will contain every possible word. Using set for O(1) lookup
...
positionsList = (
    []
)  # used to keep the lists of positions in diagram mode, since nested lists cannot be hashed
wordStarts = (
    set()
)  # set that holds every valid part of every word from beginning to some point in the middle
